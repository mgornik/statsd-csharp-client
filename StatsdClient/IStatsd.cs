...
namespace StatsdClient
{
    ...
    public interface IStatsd
    {
        ...
        /// </summary>
        void LogCount(string name, int count = 1, string source = null);
        /// <summary>
        /// Log a gauge value
        /// </summary>
        void LogGauge(string name, int value, string source = null);
        /// <summary>
        /// Log a latency / Timing
        /// </summary>
        void LogTiming(string name, int milliseconds, string source = null);
        /// <summary>
        /// Log a latency / Timing
        /// </summary>
        void LogTiming(string name, long milliseconds, string source = null);
        /// <summary>
        /// Log the number of unique occurrances of something
        /// </summary>
        /// <param name="name"></param>
        /// <param name="value"></param>
        void LogSet(string name, int value, string source = null);
        /// <summary>
        ...
        void LogCalendargram(string name, string value, string period, string source = null);
        /// <summary>
        /// Log a calendargram metric 
        /// </summary>
        /// <param name="name">The metric namespace</param>
        /// <param name="value">The unique value to be counted in the time period</param>
        /// <param name="period">The time period, can be one of h,d,dow,w,m</param>
        void LogCalendargram(string name, int value, string period, string source = null);
        /// <summary>
        ...
        void LogRaw(string name, int value, long? epoch = null, string source = null);
    }
}
